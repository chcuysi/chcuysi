...
public class marketController {
	...
	public String getProductList(Model m) {
		...
		vo7.setType2("apple");
		vo7.setCategory("과일");
		vo7.setImgName("apple");
		vo7.setType("appleSingProduct");
