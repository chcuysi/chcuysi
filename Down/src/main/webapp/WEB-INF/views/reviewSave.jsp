                    ...
                    <form id="reviewSave" action="reviewSave.do" method='post' enctype="multipart/form-data">
                        ...
                        <span>리뷰 정보를 양식에 맞게 기입해주세요.</span>
                           ...
                           <div  class="col-lg-5">
                            ...
                            <input name="iok"   class="Fileimg" type="text" value="" placeholder="맛있는 후라보노" required>
                            </fieldset>
                           ...
                           <div class="col-lg-5">
                            ...
                            <input name="type" type="text"  placeholder="1234" value="" required>
                            </fieldset>
                          </div>
                       ...
                       <div id="insertProduct-sectionHeading2" class="section-heading">
                        <div  class="col-lg-5">
                            <fieldset>
                            <label id="insertLabel"><b>리뷰 설명 요약</b></label> 
