            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="left-content">
                        ...
                        <label>이름</label><br/>
						<input type="text" name="mname" placeholder="한글5자이내" pattern="[ㄱ-힝]{2,5}" required><br/>
						<hr>
						<label>주민번호</label><br/>
						<input type="text" name="mjnum" placeholder="123456-1234567" pattern="[0-9]{,14}" required><br/>
						<hr>
						<label>아이디</label><br/>
						<input type="text" name="mid" id="mid" pattern="[0-9a-z]{5,15}" min="5" max="15" required  placeholder="5자~15자 영어와 숫자조합"><input type="button" id="check" value="아이디중복"><br/>
						<div id="idmessage"></div>
						<hr>
						<label>비밀번호</label><br/>
						<input type="password" name="mpw" id="mpw" placeholder="4자 이상 영어와 숫자조합" pattern="[0-9a-z]{4,}" required><br/>
						<hr>
						<label>비밀번호확인</label><br/>
						<input type="password" name="mpws" id="mpws" placeholder="4자 이상 영어와 숫자조합" pattern="[0-9a-z]{4,}" required><br/>					
						<hr>
						<label> 우편번호</label><br/>
						<input type="text" id="mcode" name="mcode" placeholder="우편번호" required><input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br/>
						<hr>
						<label> 주소</label><br/>
						<input type="text" id="maddr" name="maddr" placeholder="도로명주소" required  size="30"><br/>
						<hr>
						<label> 상세주소</label><br/>
						<input type="text" id="mdaddr" name="mdaddr" placeholder="상세주소"  size="30">&nbsp;(필수 아님)<br/>
						<hr>
						<label>이메일 </label><br/>
						<input type="email" name="memail" placeholder="abcd@galil.com" required size="30"><br/>
						<hr>
						<label>전화번호</label><br/>
						<input type="text" name="mtel"placeholder="010-1234-5678" required><br/>
						<hr>
                        <div class="main-border-button">
                            <input type="submit" id="membership" value="회원가입">
                        </div>
                        </form>
					</div>
						 </div>
    ...
    function sample4_execDaumPostcode() {
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                document.getElementById('mcode').value = data.zonecode;
                document.getElementById("maddr").value = roadAddr;
...
$(function () {
	$('#membership').click(function (evt) {
		
		var idck = $('#idmessage').text();
		
		if( idck=="" ) {
			alert("아이디 중복체크 안함")
		}else if( idck == "이미 사용 중인 아이디 입니다."){
		...
		if( $('#mpw').val() == $('#mpws').val() ){
			$("#member_form").attr("action","saveMember.do");
			alert('ㅎㅎ');
		}
	...
	$('#check').click(function() {
		...
		$.ajax({
			type: 'post',
			url:'select.do', // MVC 패턴으로 사용하기 .jsp 안됨
