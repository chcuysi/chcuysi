...
<div class="templatemo-content-container">
	<div class="templatemo-content-widget no-padding">
		<div class="panel panel-default table-responsive">
			<table id="table_detailPsale" class="table table-striped table-bordered cate_detail">
				<tbody>
					<tr>
	...
	<div style="width:100px; text-align: center;margin:auto; display: flex;">
    	<!-- 상세정보창 내용 수정 -->
        <button type="button" class="btn_modify_psale">수정</button>
        <!-- 상세정보창 내용 수정사항 취소 -->
	   	<button type="button" class="btn_cancel_psale">취소</button>
    </div>         
</form>
