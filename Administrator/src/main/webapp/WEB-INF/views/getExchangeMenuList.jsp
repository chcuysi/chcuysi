        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget no-padding">
            <div class="panel panel-default table-responsive">
              <table id="table_exchange" class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
...
<form id = 'detailInfo_exchange' action="updateExchange"> <!-- 'updateExchange.do를 줄여씀' -->
