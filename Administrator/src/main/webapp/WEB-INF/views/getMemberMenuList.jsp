          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              ...
              <ul class="text-uppercase">
                <li><a href="getMemberMenuList.do" class="active">일반회원</a></li>
                <li><a href="getPsaleMenuList.do">판매자회원</a></li>
              </ul>  
            </nav> 
          </div>
        </div>
                ...
                <tbody>
                		<!-- 각 컬럼에 상응하는 값들: taglib 이용한 for문으로 출력 -->
                  		<c:forEach items="${memberMenuList}" var="memberMenu">
		                   <tr>
		                       <td>${memberMenu.mnum}</td>
		                       <td>${memberMenu.mid}</td>
